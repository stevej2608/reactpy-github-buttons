...
{(function(){var React=reactExports;var _assign=requireObjectAssign();var Scheduler=requireScheduler();var tracing=requireTracing();var ReactSharedInternals=React.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;// by calls to these methods by a Babel plugin.
	//
	// In PROD (or in packages without access to React internals),
	// they are left as they are instead.
...
var createElement = createElementInDocument(document$1);
...
var ceilPixel = function (px) {
  return (devicePixelRatio > 1 ? Math$1.ceil(Math$1.round(px * devicePixelRatio) / devicePixelRatio * 2) / 2 : Math$1.ceil(px)) || 0;
};
var get = function (el) {
  ...
  if (el.getBoundingClientRect) {
    ...
    width = Math$1.max(width, ceilPixel(boundingClientRect.width));
    height = Math$1.max(height, ceilPixel(boundingClientRect.height));
  }
  return [width, height];
};
  ...
  if (useShadowDOM) {
    ...
    var callback = function () {
      ...
      try {
        ...
        document$1.body.appendChild(iframe.parentNode.removeChild(iframe));
        return;
      }
...
function RactpyGithubButtons(props) {
  ...
  return /*#__PURE__*/React.createElement("a", _extends({}, props, {
    ref: ref
  }), /*#__PURE__*/React.createElement("div", props, props.data_text));
}
